...
// Helper to check if a password looks hashed
...
interface Group {
  ...
  description?: string;
  permissions: string[]; // security permissions
}
    ...
    const runDRTest = async () => {
      try {
        ...
        if (response.ok) {
          ...
          // Simulate a successful DR test with validation (already declared dateStr and recTime above)
...
/* Backup Code */
    ...
    return (
      <div className="space-y-8 p-8 bg-white dark:bg-gray-900 min-h-screen">
