    ...
    async function handleLogin(username, password) {
        ...
        try {
            ...
            try {
                ...
                console.warn('Failed to create session', e_0);
            }
            setCurrentUser({
                name: user.name || name,
                username: user.username || name,
                email: user.email,
                avatar: user.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(user.name || name)}`
            });
            return {
                ok: true,
                user
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                ...
                                onError: (e_1)=>{
                                    e_1.currentTarget.onerror = null;
                                    e_1.currentTarget.src = 'https://ui-avatars.com/api/?name=' + encodeURIComponent(currentUser?.name || 'DocRST');
                                }
                            }, void 0, false, {
                                fileName: "[project]/client/src/app/(components)/Navbar/index.tsx",
                                lineNumber: 149,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                ...
                                children: currentUser?.name ?? 'DocRST'
                            }, void 0, false, {
                                fileName: "[project]/client/src/app/(components)/Navbar/index.tsx",
                                lineNumber: 153,
                                columnNumber: 13
...
_s(Navbar, "iraNtyMOE9VoIoFLRVaZe7iZevg=", false, function() {
    return [
...
const SidebarLink = (t0)=>{
    ...
    if ($[0] !== "d9254e5a69bbece292418232033067e9d70ec4fed8d0103cdfc3bad50c9814ef") {
        for(let $i = 0; $i < 13; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "d9254e5a69bbece292418232033067e9d70ec4fed8d0103cdfc3bad50c9814ef";
    }
...
_s1(Sidebar, "er80saNXPaRhSpEvmAIeNBnWLsA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$src$2f$app$2f$redux$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppDispatch"],
        __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$src$2f$app$2f$redux$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"],
        __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$src$2f$app$2f$redux$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"],
...
const DashboardLayout = (t0)=>{
    ...
    if ($[0] !== "d8272eb4f74825df8fca39b235ce7dd584e61b7354b1b98afc24598051b0da66") {
        for(let $i = 0; $i < 17; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "d8272eb4f74825df8fca39b235ce7dd584e61b7354b1b98afc24598051b0da66";
    }
    const { children } = t0;
    ...
    const sidebarWidth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$src$2f$app$2f$redux$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])(_temp3);
    let t1;
    let t2;
    if ($[1] !== isDarkMode) {
        t1 = ()=>{
    ...
    const clampedSidebarWidth = Math.min(Math.max(sidebarWidth, 120), 320);
    isSidebarCollapsed ? 64 : clampedSidebarWidth;
    const t3 = isDarkMode ? "#111827" : "#f9fafb";
    const t4 = isDarkMode ? "#f3f4f6" : "#111827";
    let t5;
    if ($[4] !== t3 || $[5] !== t4) {
        t5 = {
            backgroundColor: t3,
    ...
    const t7 = isDarkMode ? "#111827" : "#f9fafb";
    let t8;
    if ($[8] !== t7) {
        t8 = {
            backgroundColor: t7,
    ...
    let t10;
    if ($[11] !== children || $[12] !== t8) {
        t10 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
...
_s(DashboardLayout, "IR38UMIbTXmm0LroKp/bt+QVop8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$src$2f$app$2f$redux$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"],
        __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$src$2f$app$2f$redux$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"],
        __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$src$2f$app$2f$redux$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"]
...
function _temp3(state_1) {
    return state_1.global.sidebarWidth;
}
var _c, _c1;
