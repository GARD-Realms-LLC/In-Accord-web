...
const Navbar = ()=>{
    ...
    const avatarUrl = currentUser?.avatar || currentUser?.avatarUrl || 'https://ui-avatars.com/api/?name=DocRST';
...
_s(Navbar, "YFC/BzQ/vEjg2FvdNNPXQ4KAmTU=", false, function() {
    return [
